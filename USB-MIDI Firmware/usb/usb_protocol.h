...
#define USB_V1_1 (0x0110) /*!< USB Specification version 1.10 */
...
/** Build bytes for USB endpoint descriptor USB 1.0. */
#define USB_ENDP_1_DESC_BYTES(bEndpointAddress, bmAttributes, wMaxPacketSize, bInterval)									\
USB_ENDP_1_DESC_LEN,/* bLength */																										\
USB_DT_ENDPOINT, /* bDescriptorType: ENDPOINT */																			\
bEndpointAddress, bmAttributes, LE_BYTE0(wMaxPacketSize), LE_BYTE1(wMaxPacketSize), bInterval, 0x00, 0x00

#define USB_ENDP_1_DESC_LEN 9
